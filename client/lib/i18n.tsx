...
const dictionary: Record<Lang, Record<string, string>> = {
  ...
  kn: {
    ...
    news_page_article_4_excerpt: "ವಿದ್ಯಾರ್ಥಿಗಳ ಪ್ರಗತಿ ಮತ್ತು ಶೈಕ್ಷಣಿಕ ಅಭಿವೃದ್ಧಿಯನ್ನು ಚರ್ಚಿಸಲು ಯಶಸ್ವಿ ಪೋಷಕ-ಶಿಕ್ಷಕರ ಸಭೆ ನಡೆಯಿತು.",
    news_page_article_4_content: "ತ್ರೈಮಾಸಿಕ ಪೋಷಕ-ಶಿಕ್ಷಕರ ಸಭೆಯಲ್ಲಿ ಪೋಷಕರ ಉತ್ತಮ ಭಾಗವಹಿಸುವಿಕೆ ಕಂಡುಬಂತು. ಶಿಕ್ಷಕರು ಪ್ರತಿ ವಿದ್ಯಾರ್ಥಿಯ ಪ್ರಗತಿ, ಶೈಕ್ಷಣಿಕ ಪ್ರದರ್ಶನ ಹಾಗೂ ಸುಧಾರಣೆಯ ಅಂಶಗಳನ್ನು ಪೋಷಕರೊಂದಿಗೆ ಚರ್ಚಿಸಿದರು.",
    ...
    news_page_article_5_excerpt: "ದೇಶಭಕ್ತಿ ಗೀತೆಗಳು, ಭಾಷಣಗಳು ಮತ್ತು ಸಾಂಸ್ಕೃತಿಕ ಕಾರ್ಯಕ್ರಮಗಳೊಂದಿಗೆ ವಿದ್ಯಾರ್ಥಿಗಳು ಸ್ವಾತಂತ್ರ್ಯ ದಿನವನ್ನು ಆಚರಿಸಿದರು.",
    news_page_article_5_content: "ಸ್ವಾತಂತ್ರ್ಯ ದಿನಾಚರಣೆ ದೇಶಭಕ್ತಿ ಭಾವದಿಂದ ನಡೆದಿತು. ವಿದ್ಯಾರ್ಥಿಗಳು ದೇಶಭಕ್ತಿ ಗೀತೆಗಳನ್ನು ಹಾಡಿ, ಸ್ವಾತಂತ್ರ್ಯ ಹೋರಾಟಗಾರರ ಬಗ್ಗೆ ಭಾಷಣ ನೀಡಿ, ಭಾರತದ ಸ್ವಾತಂತ್ರ್ಯವನ್ನು ಆಚರಿಸುವ ಸಾಂಸ್ಕೃತಿಕ ಕಾರ್ಯಕ್ರಮಗಳಲ್ಲಿ ಭಾಗವಹಿಸಿದರು.",
